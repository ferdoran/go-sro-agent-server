...
import (
	...
	"gitlab.ferdoran.de/game-dev/go-sro/agent-server/handler/character"
	"gitlab.ferdoran.de/game-dev/go-sro/agent-server/handler/chat"
	"gitlab.ferdoran.de/game-dev/go-sro/agent-server/handler/inventory"
	"gitlab.ferdoran.de/game-dev/go-sro/agent-server/handler/lobby"
	"gitlab.ferdoran.de/game-dev/go-sro/agent-server/handler/logout"
	"gitlab.ferdoran.de/game-dev/go-sro/agent-server/handler/party"
	"gitlab.ferdoran.de/game-dev/go-sro/agent-server/handler/stall"
	"gitlab.ferdoran.de/game-dev/go-sro/agent-server/manager"
	...
	gwHandlers "gitlab.ferdoran.de/game-dev/go-sro/gateway-server/handler"
	"os"
)

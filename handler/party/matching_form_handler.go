...
func NewPartyMatchingFormHandler() server.PacketHandler {
	handler := PartyMatchingFormHandler{}
	server.PacketManagerInstance.RegisterHandler(opcode.PartyMatchingFormRequest, handler)
	return handler
}

func (h PartyMatchingFormHandler) Handle(data server.PacketChannelData) {
